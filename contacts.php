...
// Search contacts if search query is provided
if (isset($_POST['search'])) {
    $search = $_POST['search'];
    $sqlSearch = "SELECT name, company, phone, email FROM contacts WHERE name LIKE '%$search%' OR company LIKE '%$search%' OR phone LIKE '%$search%' OR email LIKE '%$search%'";
